...
namespace TTTbook
{
  ...
  static const char* ps_header =
    ...
    "/TTTbook_go_to_half TTTbook_field_size TTTbook_hash_line_width sub TTTbook_hash_line_width sub 2 div def\n"
    ...
    "%%Page: 1 1\n"
    "TTTbook_init\n"
    "/HelveticaBold findfont 20 scalefont setfont\n"
    "newpath 10 10 moveto (TTTbook) show\n"
    "TTTbook_grid\n"
    "showpage\n"
    "\n";
