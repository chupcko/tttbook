...
namespace TTTbook
{
  ...
  static const char* ps_header =
    ...
    "/TTTbook_go_to_begin\n"
    "{\n"
    "  [ /Rect [ 0 0 TTTbook_page_size TTTbook_page_size ] /Border [ 0 0 0 ] /Page TTTbook_page_number_offset /View [ /XYZ null null null ] /Subtype /Link /ANN pdfmark\n"
    "} def\n"
    "\n"
    "%%EndResource\n"
    ...
    "\n"
    "%%EndResource\n"
    "%%BeginResource: TTTbook_center_uri\n"
    "\n"
    "/TTTbook_center_uri\n"
    "{\n"
    "  7 dict begin\n"
    ...
    "    /width exch def\n"
    "    gsave\n"
    "      width 2 div neg 0 rmoveto uri true charpath pathbbox\n"
    "      /ury exch def /urx exch def /lly exch def /llx exch def\n"
    "    grestore\n"
    "    width 2 div neg 0 rmoveto uri show\n"
    "    [ /Rect [ llx lly urx ury ] /Border [ 0 0 0 ] /Action << /Subtype /URI /URI uri >> /Subtype /Link /ANN pdfmark\n"
    "  end\n"
    "} def\n"
    "\n"
    "%%EndResource\n"
    ...
    "      [ /Rect [ TTTbook_go_to_half neg TTTbook_go_to_half neg TTTbook_go_to_half TTTbook_go_to_half ] /Border [ 0 0 0 ] /Page go_to cvi TTTbook_page_number_offset add /View [ /XYZ null null null ] /Subtype /Link /ANN pdfmark\n"
    "    grestore\n"
    "  end\n"
    "} def\n"
    "\n"
    ...
    "\n"
    "%%Page: 1 1\n"
    "TTTbook_init TTTbook_go_to_begin\n"
    "gsave\n"
    "  TTTbook_gray setgray\n"
    ...
    "  TTTbook_font 2 selectfont\n"
    "  newpath TTTbook_page_half 67 moveto (http://github.com/chupcko/tttbook/) TTTbook_center_uri\n"
    "  TTTbook_font 7 selectfont\n"
    "  newpath TTTbook_page_half 57 moveto (by CHUPCKO) TTTbook_center_show\n"
    "  TTTbook_font 2 selectfont\n"
    "  newpath TTTbook_page_half 54 moveto (http://www.chupcko.org/) TTTbook_center_uri\n"
